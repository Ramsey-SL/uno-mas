...
- **Day-deal cards:** *(Thursday updated 2026-08 → Big F’N Thursday)* Big-day editorial; icons now use real DAM line-art — taco `TTAsset_2_4x_vv5mg9` (pink), pint `UM_-_Daily_Specials_-_June_2026_wtgpaz` (navy), quesadilla `quesadilla-lineart-teal` (blue) *(was burrito `Burrito_-_source_kn4mzk` until Thursday changed 2026-08)*. Burrito icon enlarged to match the taco/pint icon sizing and mirrored horizontally. Deals: Taco Tuesday = **$6 margs** (matches CLAUDE.md), **Beer & Bites Wednesday** ($5 pints · $10 loaded nachos · $10 loaded masa fries), **Big F’N Thursday** ($10 Big F’N Quesadilla · $10 menu tequila cocktail fresh sheet) — replaced Burrito Thursday 2026-08.
