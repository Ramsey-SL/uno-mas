...
**Big F’N Thursday cocktails:** the offer is **$10 Tequila Cocktails\***, and the asterisk means
**\*menu cocktails only** — not custom or off-menu builds. State the asterisk wherever the price appears.
*(The rotating "fresh sheet / new pours weekly" claim was **retired 2026-08-25** — do not use it.)*
...
- **Weekly specials (live 2026-06) — these REPLACE Happy Hour AND the old lunch special (both retired):** Taco Tuesday (BOGO lunch street tacos · $6 margs · $30 marg pitchers) · Beer & Bites Wednesday ($5 pints · $10 loaded nachos · $10 loaded masa fries) · **Big F’N Thursday ($10 Big F’N Quesadilla · $10 Tequila Cocktails\* — \*menu cocktails only)**. *(Taco Tuesday IS now running — old "don't reference Taco Tuesday" rule retired. Do NOT reference the old **3–5pm Happy Hour** — retired. *(This does not apply to **Late Night Happy Hour**, Fri+Sat 8–10pm — a distinct program. Staff must be able to tell them apart.)* **Burrito Thursday ($15 House Burrito or Bowl) is RETIRED as of 2026-08 — replaced by Big F’N Thursday.**)*
- **Late Night Happy Hour — FRI + SAT ONLY, 8–10pm** (launching 2026-08-28): $6 margs · $30 marg pitchers · $5 pints · $4 well shots · **pick any two street tacos $10** (all street proteins EXCEPT Camaron/shrimp; "Two Street Tacos — $10", never "$10 tacos" — $10 already means one Big A** taco). *Tacos only, no side — the 2-tacos-plus-side combo stays $16.50.* **Ruled Fri–Sat 2026-08-23 because Tue–Thu close at 8pm.**
- Phone: (509) 960-7989
...
| **Meta ad copy — every day-of-week promo** | `marketing/campaigns/meta-ads-day-of-week.md` |
| **Meta ad copy — Taco Tuesday (8 variants)** | `marketing/campaigns/taco-tuesday-meta-ads.md` |
| **Daily-special site banners (the set)** | `marketing/campaigns/daily-special-banners/` |
