# Uno Más — Active Campaign Index (2026-06)

7 campaign moments/programs. Each gets a brief (from `_brief-template.md`) → collateral → website integration.
...
| 6 | Off-Site Catering | service | `catering/` | ⬜ | menu/packages, min order, delivery radius, lead time, contact |
| 7 | Cantina Club Loyalty | retention re-push | `cantina-club-loyalty/` | ⬜ | current mechanics, the "harder push" angle/incentive |

**Status legend:** ⬜ not started · 🟡 brief drafted · 🟢 collateral built · ✅ live on site

**Reference:** brand voice + facts in `brand-context-pack.md`; existing examples in `2026-04-dinner-launch/`, `2026-05-cinco-weekend/`. Photos/video in the DAM (Cloudinary, tagged).
