...
4. **Weekend spend promo.** The handoff flags "verify whether the Toast promo remains active." The repo has it as a **locked offer** in `weekend-campaigns-and-flows.md` ($10 off $60, Fri–Sun). The handoff's **"Mas Please" verbal redemption phrase is new** and is NOT in the repo — the repo documents "show this text/email at your table" or a `WEEKEND10` Toast code. Needs reconciliation.
