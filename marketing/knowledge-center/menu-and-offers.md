...
| **Batata** *(can be made vegan)* | Grilled sweet potato + melted Monterey Jack cheese + pickled onion + cilantro + salsa aguacate |
| **Hongos** *(can be made vegan)* | Chile roasted portabella + melted Monterey Jack cheese + spicy roja + cilantro + pickled daikon + tomatillo + shaved radish |

**Add-ons:** Guacamole or Crema +$1.50 | Additional sauces +$1.50

---

### Big A** ¼lb Tacos (Premium Tier)
**Price:** $10 each | 2 Big A** ¼lb Tacos + Side: $23
Same proteins as street tacos. Bigger, bolder, made for the occasion.
*Sides = choice of Rice & Beans or Masa Coated Waffle Fries*

---

### Birria Tacos
**Price:** $14
**Description:** Braised chuck + melted Monterey Jack cheese + cilantro + white onion + consomé
*Not included with taco plates. Standalone item.*
...
| **Monroe** | $17 | Grilled shrimp + rice + beans + tajin slaw + pineapple salsa + chipotle mayo |
| **El Camino** | $16 | Al pastor chicken + rice + beans + pineapple + salsa verde + cilantro |
| **Batata Bowl** | $13 | Grilled sweet potato + rice + beans + salsa aguacate + cilantro + pickled red onion |

### Copywriting Notes for Bowls
- The Zag = Gonzaga nod, great for community content. Now $20.
- Monroe Bowl = named after the street. Local pride. Now $17.
- Batata Bowl = plant-based/vegan. Now $13.
- Bowls position Uno Más as a full-meal destination
...
### Copywriting Notes for Shareables
- Starter Trio ($45) = the table-starter play. "Start here. End happy." — use this line.
- Lula Wings are $18 for 1 lb. The menu description is the gold standard: "Crunchy, bright, & hitting every flavor note."
- BFQ = the name does the work. "The Big F*** Quesadilla. It's exactly what it sounds like."
- Loaded Masa Coated Fries replaced Loaded Waffle Fries — use the new name
- Protein add-ons use SKIRT STEAK (not just "steak")
...
| Side | Price | Description |
|---|---|---|
| **Cilantro Lime Rice** | $6 | "What it sounds like" |
| **Black Beans** | $7 | Queso fresco + lime + cilantro |
...
### Churros
**Price:** $7
Three churros dusted in cinnamon sugar, served with house whipped cream, fresh strawberries, and chocolate dipping sauce.
*"You already know you want them. Start here, end here, we won't judge."*

---

## 9. COCKTAILS

*Uno Más is a tequila bar. Own this identity in all drink content.*
*Order Flights available — ask server.*
...
- Frozen Margarita flavors rotate — good mystery content
...
- Pitchers are great for group content, patio content, and weekend dining
- "Order a pitcher. Stay longer than you planned." — good framing
...
### On Tap
- Draft 16oz: $7 | 20oz: $8
- Domestic: $5 | Imports: $6 | N/A Beer: $6

### Beer Cocktails
| Item | Price | Description |
|---|---|---|
| **Michelada** | $8 | Housemade michelada mix + choice of beer + housemade chamoy + tajin rim + lime wedge garnish |
| **Cheleda** | $7 | Salted rim + lime juice + choice of beer |

### Buckets of Beer
| Selection | Price |
|---|---|
| Bud Light / Michelob Ultra / Coors Light | $15 |
| Modelo / Pacifico / Corona / Modelo Negra | $25 |

### Non-Alcoholic
| Item | Price |
|---|---|
| Agua Fresca's | $5 (ask about flavors) |
...
*Mocktails available — ask server*
...
| **Big F’N Thursday** | $10 Big F’N Quesadilla (BFQ) · $10 menu cocktails (fresh sheet, new pours weekly) (new cocktails weekly) |
...
### The Essentials
**Price:** $750 (weekdays) / $850 (Fri/Sat)
**Group Size:** 15–25 people
**Includes:**
- Guacamole & salsa bar with chips
- Choice of 2 taco trays (10 Big A** ¼lb tacos of your choice)
- Protein options: Carne Asada, Carnitas, Al Pastor, Chicken, Sweet Potato, Hongos
- 3 hours of space rental
- Soda, iced tea & lemonade included
- Cash bar available for cocktails, beer & tequila

---

### The Fiesta
**Price:** $1,200 (weekdays) / $1,400 (Fri/Sat)
**Group Size:** 20–30 people
**Includes:**
- Guacamole & salsa bar with chips
- Choice of 3 taco trays (15 Big A** ¼lb tacos)
- Protein options: Carne Asada, Carnitas, Al Pastor, Chicken, Sweet Potato, Hongos
- Choice of 1: Party nachos OR party loaded fries (choice of protein)
- Choice of 1: Party wings OR 1 Big A** Quesadilla (choice of protein)
- 3 hours of space rental
- Soda, iced tea & lemonade included
- Cash bar available

*Also available for online order via Toast — see VENUE_AND_OPERATIONS.md for link*

---

### The Full Send
**Price:** $1,800 (weekdays) / $2,000 (Fri/Sat)
**Group Size:** 25–37 people
**Includes:**
- Guacamole & salsa bar with chips
- Choice of 4 taco trays (20 Big A** ¼lb tacos)
- Party nachos AND party loaded fries (choice of protein for each)
- Party wings
- 2 Big A** Quesadillas (choice of protein)
- 3 hours of space rental
- Soda, iced tea & lemonade included
- **$200 bar tab included** (beer, wine, well cocktails)
- Cash bar available after tab is used

---

### Add-Ons (All Packages)
- Additional taco trays: $35
- Extra party nachos/wings/loaded fries: $30
- Additional Big A** Quesadillas: $25
- Hosted bar upgrade: $10/person (beer, wine, well cocktails)

**Note:** 20% gratuity added to all private events.

### Copywriting Notes for Mezzanine Packages
- Use package names: "The Essentials," "The Fiesta," "The Full Send"
- Always include group size and total price
- Full Send has $200 bar tab included — key differentiator
- Gratuity (20%) is fine print, not headline
- For full private event inquiries: karissa@unomastacoshop.com
...
*Changes in v2.7 (2026-08-25): Thursday cocktail offer broadened from **tequila cocktails** to **$10 menu cocktails** (fresh sheet, new pours weekly). **Late Night Happy Hour renamed "Late Night Happy Hour"** — the old 3–5pm Happy Hour retirement rule narrowed accordingly so the two don't collide.*
