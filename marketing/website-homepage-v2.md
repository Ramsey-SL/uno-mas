...
5. **What's On This Week (C3)** — NEW: events ticker + day-special chips.
   ...
   - **Daily specials chips** → `/specials`: Taco Tuesday (BOGO street tacos · $6 margs · $30 pitchers) · $5 Wednesday ($5 pints · $5 street tacos) · Burrito Thursday ($15 house burrito or bowl).
